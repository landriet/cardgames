  ...
  render: (args) => {
    ...
    return (
      <div className="flex flex-col items-center justify-center h-screen">
        <button className="mb-6 px-6 py-2 bg-blue-600 text-white rounded shadow hover:bg-blue-700 transition" onClick={() => setOpen(true)}>
          Show Popup
        </button>
        <Modal isOpen={open} onClose={() => setOpen(false)} ariaLabel={args.ariaLabel}>
          ...
          <button className="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 transition" onClick={() => setOpen(false)}>
            Close
          </button>
        </Modal>
      </div>
